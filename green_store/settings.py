...
SECRET_KEY = 'django-insecure-zmtx4y+386tit&pc)kc)f+cam#y3$1hut*(n33-g2l6d*+polm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # allouth
...
STRIPE_WH_SECRET = os.getenv('STRIPE_WH_SECRET', 'whsec_3VwClOFY8kIigicQqc4nZrHpeVnXelU1')
